...
public class FormBase : IDisposable
{
    ...
    /// </summary>
    /// <param name="control"></param>
    public async Task RemoveControl(ControlBase control)
    {
        if (!Controls.Contains(control))
            return;
    ...
    /// </summary>
    public async Task RemoveAllControls()
    {
