...
using Denpou.Enums;
using Denpou.Form;
using DenpouControls.Examples.Controls;
using DenpouControls.Examples.DataSources;
...
public class Menu : AutoCleanForm
{
    ...
    {
        if (message.Message.Chat.Type is ChatType.Group or ChatType.Supergroup)
        {
    ...
    public override async Task Render(MessageResult message)
    {
        ...
        btn.AddButtonRow(new ButtonBase("#4 Registration Example",
            new CallbackData("a", "registration").Serialize()));
        ...
        btn.AddButtonRow(new ButtonBase("#16 CheckedButtonList",
            new CallbackData("a", "checkedbuttonlist").Serialize()));
